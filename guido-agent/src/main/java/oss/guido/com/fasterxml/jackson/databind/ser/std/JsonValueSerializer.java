...
import oss.guido.com.fasterxml.jackson.databind.ser.BeanSerializer;
import oss.guido.com.fasterxml.jackson.databind.ser.ContextualSerializer;

/**
 * Serializer class that can serialize Object that have a
 * {@link oss.guido.com.fasterxml.jackson.annotation.JsonValue} annotation to
    ...
    implements ContextualSerializer, JsonFormatVisitable, SchemaAware
{
     ...
     *    {@link oss.guido.com.fasterxml.jackson.databind.annotation.JsonSerialize#using}), otherwise
     *    null
     */
...
//            TypeSerializer typeSer = new TypeSerializerWrapper(typeSer0, bean);
        ...
        throws JsonMappingException
    {
        ...
        return oss.guido.com.fasterxml.jackson.databind.jsonschema.JsonSchema.getDefaultSchemaNode();
    }
