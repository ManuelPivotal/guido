...
import oss.guido.javassist.bytecode.ConstantAttribute;
import oss.guido.javassist.bytecode.Descriptor;
import oss.guido.javassist.bytecode.EnclosingMethodAttribute;
import oss.guido.javassist.bytecode.FieldInfo;
import oss.guido.javassist.bytecode.InnerClassesAttribute;
...
import oss.guido.javassist.compiler.AccessorMaker;
...
class CtClassType extends CtClass {
   ...
   /**
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    return oss.guido.javassist.bytecode.annotation.AnnotationImpl.make(
    ...
    /**
     * @see oss.guido.javassist.CtClass#prune()
     * @see oss.guido.javassist.CtClass#stopPruning(boolean)
     */
    public void prune() {
        if (wasPruned)
            return;
