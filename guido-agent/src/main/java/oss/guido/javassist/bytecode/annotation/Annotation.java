 ...
 *
 * @see oss.guido.javassist.bytecode.AnnotationsAttribute#getAnnotations()
 * @see oss.guido.javassist.bytecode.ParameterAnnotationsAttribute#getAnnotations()
 * @see MemberValue
...
public class Annotation {
     ...
     * the default value.
     *
     * @see oss.guido.javassist.bytecode.AnnotationDefaultAttribute
     */
