 ...
 */
package oss.guido.ch.qos.logback.classic.pattern.color;

import static oss.guido.ch.qos.logback.core.pattern.color.ANSIConstants.BLUE_FG;
import static oss.guido.ch.qos.logback.core.pattern.color.ANSIConstants.BOLD;
import static oss.guido.ch.qos.logback.core.pattern.color.ANSIConstants.DEFAULT_FG;
import static oss.guido.ch.qos.logback.core.pattern.color.ANSIConstants.RED_FG;
