...
import oss.guido.ch.qos.logback.core.db.dialect.H2Dialect;
import oss.guido.ch.qos.logback.core.db.dialect.HSQLDBDialect;
import oss.guido.ch.qos.logback.core.db.dialect.MsSQLDialect;
import oss.guido.ch.qos.logback.core.db.dialect.MySQLDialect;
import oss.guido.ch.qos.logback.core.db.dialect.OracleDialect;
import oss.guido.ch.qos.logback.core.db.dialect.PostgreSQLDialect;
import oss.guido.ch.qos.logback.core.db.dialect.SQLDialect;
import oss.guido.ch.qos.logback.core.db.dialect.SQLDialectCode;
import oss.guido.ch.qos.logback.core.db.dialect.SQLiteDialect;
import oss.guido.ch.qos.logback.core.db.dialect.SybaseSqlAnywhereDialect;
