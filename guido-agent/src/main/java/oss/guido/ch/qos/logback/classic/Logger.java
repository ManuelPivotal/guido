...
import oss.guido.ch.qos.logback.classic.spi.LoggingEvent;
import oss.guido.ch.qos.logback.classic.util.LoggerNameUtil;
import oss.guido.ch.qos.logback.core.Appender;
import oss.guido.ch.qos.logback.core.CoreConstants;
import oss.guido.ch.qos.logback.core.spi.AppenderAttachable;
import oss.guido.ch.qos.logback.core.spi.AppenderAttachableImpl;
import oss.guido.ch.qos.logback.core.spi.FilterReply;
import oss.guido.org.slf4j.LoggerFactory;
import oss.guido.org.slf4j.Marker;
import oss.guido.org.slf4j.spi.LocationAwareLogger;

public final class Logger implements oss.guido.org.slf4j.Logger, LocationAwareLogger,
   ...
   * information.
   */
  public static final String FQCN = oss.guido.ch.qos.logback.classic.Logger.class
      .getName();
