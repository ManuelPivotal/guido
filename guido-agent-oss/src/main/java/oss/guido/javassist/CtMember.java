...
public abstract class CtMember {
     ...
     *
     * @see oss.guido.javassist.bytecode.SignatureAttribute#toFieldSignature(String)
     * @see oss.guido.javassist.bytecode.SignatureAttribute#toMethodSignature(String)
     ...
     * @see oss.guido.javassist.bytecode.SignatureAttribute.ObjectType#encode()
