 ...
 *
 * @see oss.guido.javassist.CtClass#instrument(ExprEditor)
 * @see oss.guido.javassist.CtMethod#instrument(ExprEditor)
 * @see oss.guido.javassist.CtConstructor#instrument(ExprEditor)
 * @see MethodCall
 * @see NewExpr
 * @see FieldAccess
 *
 * @see oss.guido.javassist.CodeConverter
 */
