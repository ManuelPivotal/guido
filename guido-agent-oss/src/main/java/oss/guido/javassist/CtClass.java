...
public abstract class CtClass {
     ...
     */
    public oss.guido.javassist.compiler.AccessorMaker getAccessorMaker() {
        return null;
    }
     ...
     * @see oss.guido.javassist.bytecode.SignatureAttribute#toClassSignature(String)
     ...
     * @see oss.guido.javassist.bytecode.SignatureAttribute.ClassSignature#encode()
     * @see oss.guido.javassist.bytecode.SignatureAttribute.MethodSignature#encode()
     ...
     * @see oss.guido.javassist.bytecode.Descriptor
     */
     ...
     *
     * @see oss.guido.javassist.CtConstructor
     */
     ...
     * are not included.
     *
     * @see oss.guido.javassist.CtMethod
     */
     ...
     *
     * @see oss.guido.javassist.CtField#CtField(CtField,CtClass)
     */
     ...
     *
     * @see oss.guido.javassist.CtField.Initializer#byExpr(String)
     * @see oss.guido.javassist.CtField#CtField(CtField,CtClass)
     */
     ...
     * @see oss.guido.javassist.bytecode.AttributeInfo
     */
