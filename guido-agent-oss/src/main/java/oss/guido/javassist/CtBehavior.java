...
public abstract class CtBehavior extends CtMember {
     ...
     *
     * @see oss.guido.javassist.bytecode.MethodInfo#rebuildStackMap(ClassPool)
     */
     ...
     * It represents parameter types including type variables.
     * See {@link oss.guido.javassist.CtClass#setGenericSignature(String)}
     * for a code sample.
     *
     ...
     * See {@link oss.guido.javassist.bytecode.AttributeInfo}.
     *
     ...
     *
     * @see oss.guido.javassist.runtime.Cflow
     */
     ...
     * @see oss.guido.javassist.expr.Expr#replace(String)
     * @see #insertBefore(String)
     */
