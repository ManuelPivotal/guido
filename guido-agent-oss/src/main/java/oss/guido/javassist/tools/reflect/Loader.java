 ...
 *
 * @see oss.guido.javassist.tools.reflect.Reflection
 * @see oss.guido.javassist.tools.reflect.Compiler
 * @see oss.guido.javassist.Loader
 */
public class Loader extends oss.guido.javassist.Loader {
     ...
     *
     * @see oss.guido.javassist.tools.reflect.Metaobject
     * @see oss.guido.javassist.tools.reflect.ClassMetaobject
     */
