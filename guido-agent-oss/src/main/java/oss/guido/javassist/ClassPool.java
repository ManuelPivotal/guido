 ...
 *
 * @see oss.guido.javassist.CtClass
 * @see oss.guido.javassist.ClassPath
 */
public class ClassPool {
     ...
     * @see oss.guido.javassist.ClassPool#getDefault()
     */
     ...
     * @see #get(String)
     * @see oss.guido.javassist.bytecode.ConstPool#getClassInfo(int)
     * @see oss.guido.javassist.bytecode.Descriptor#toCtClass(String, ClassPool)
     * @since 3.8.1
     */
     ...
     * @see oss.guido.javassist.ByteArrayClassPath
     */
     ...
     * @see oss.guido.javassist.ClassPath
     * @see oss.guido.javassist.URLClassPath
     * @see oss.guido.javassist.ByteArrayClassPath
     */
