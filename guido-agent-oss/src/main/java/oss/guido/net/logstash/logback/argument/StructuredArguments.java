 ...
 */
package oss.guido.net.logstash.logback.argument;

import java.util.Arrays;
import java.util.Map;

import oss.guido.ch.qos.logback.core.Context;
import oss.guido.net.logstash.logback.marker.MapEntriesAppendingMarker;
import oss.guido.net.logstash.logback.marker.ObjectAppendingMarker;
import oss.guido.net.logstash.logback.marker.ObjectFieldsAppendingMarker;
import oss.guido.net.logstash.logback.marker.RawJsonAppendingMarker;
