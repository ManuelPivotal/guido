...
public class HostnameJsonProvider extends AbstractFieldJsonProvider<IAccessEvent> implements FieldNamesAware<LogstashAccessFieldNames> {

    public static final String FIELD_HOSTNAME = "@fields.HOSTNAME";
    
    public HostnameJsonProvider() {
        setFieldName(FIELD_HOSTNAME);
    }
    ...
    public void setFieldNames(LogstashAccessFieldNames fieldNames) {
        setFieldName(fieldNames.getFieldsHostname());
    }
