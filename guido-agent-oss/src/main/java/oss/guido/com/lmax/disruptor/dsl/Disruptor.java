...
import oss.guido.com.lmax.disruptor.BatchEventProcessor;
import oss.guido.com.lmax.disruptor.EventFactory;
import oss.guido.com.lmax.disruptor.EventHandler;
import oss.guido.com.lmax.disruptor.EventProcessor;
import oss.guido.com.lmax.disruptor.EventTranslator;
import oss.guido.com.lmax.disruptor.EventTranslatorOneArg;
import oss.guido.com.lmax.disruptor.ExceptionHandler;
import oss.guido.com.lmax.disruptor.RingBuffer;
import oss.guido.com.lmax.disruptor.Sequence;
import oss.guido.com.lmax.disruptor.SequenceBarrier;
import oss.guido.com.lmax.disruptor.TimeoutException;
import oss.guido.com.lmax.disruptor.WaitStrategy;
import oss.guido.com.lmax.disruptor.WorkHandler;
import oss.guido.com.lmax.disruptor.WorkerPool;
...
public class Disruptor<T>
{
    ...
    /**
     * Create a new Disruptor. Will default to {@link oss.guido.com.lmax.disruptor.BlockingWaitStrategy} and
     ...
     *
     * @param handlers the event handlers, previously set up with {@link #handleEventsWith(oss.guido.com.lmax.disruptor.EventHandler[])},
     ...
     *
     * @param processors the event processors, previously set up with {@link #handleEventsWith(oss.guido.com.lmax.disruptor.EventProcessor...)},
     *                   that will form the barrier for subsequent handlers or processors.
     * @return an {@link EventHandlerGroup} that can be used to setup a {@link SequenceBarrier} over the specified event processors.
     * @see #after(oss.guido.com.lmax.disruptor.EventHandler[])
     */
    ...
    /**
     * Calls {@link oss.guido.com.lmax.disruptor.EventProcessor#halt()} on all of the event processors created via this disruptor.
     */
    public void halt()
    {
        for (final ConsumerInfo consumerInfo : consumerRepository)
     ...
     * @see oss.guido.com.lmax.disruptor.Sequencer#getBufferSize()
     */
