 ...
 */
package oss.guido.ch.qos.logback.classic.net;
...
import oss.guido.ch.qos.logback.classic.PatternLayout;
import oss.guido.ch.qos.logback.classic.pattern.SyslogStartConverter;
import oss.guido.ch.qos.logback.classic.spi.ILoggingEvent;
import oss.guido.ch.qos.logback.classic.spi.IThrowableProxy;
import oss.guido.ch.qos.logback.classic.spi.StackTraceElementProxy;
import oss.guido.ch.qos.logback.classic.util.LevelToSyslogSeverity;
import oss.guido.ch.qos.logback.core.CoreConstants;
import oss.guido.ch.qos.logback.core.Layout;
import oss.guido.ch.qos.logback.core.net.SyslogAppenderBase;
import oss.guido.ch.qos.logback.core.net.SyslogOutputStream;
...
public class SyslogAppender extends SyslogAppenderBase<ILoggingEvent> {
   ...
   *
   * @see oss.guido.ch.qos.logback.core.net.SyslogAppenderBase#getSeverityForEvent(java.lang.Object)
   */
  @Override
